...
// Posts Endpoints
export const fetchPosts = () => API.get('/posts/'); // GET /posts/
export const createPost = (postData) => API.post('/posts/', postData); // POST /posts/

// Live Sessions Endpoints
export const fetchLiveSessions = () => API.get('/lives/'); // GET /lives/
...
// Events Endpoints
export const fetchEvents = () => API.get('/events/'); // GET /events/
